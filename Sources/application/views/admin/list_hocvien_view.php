                ...
                <?php foreach ($arrHV as $row){?>
                    <tr class="w3-animate-left">
                        <td align="center">
                            ...
                            <a class="btn btn-default" onclick="return confirm('Bạn có muốn xóa không');" href = "<?php echo base_url();?>index.php/admin/deletehv/<?php echo $row['MAHV'];?>"><em class="fa fa-trash"></em></a>
                        </td>
