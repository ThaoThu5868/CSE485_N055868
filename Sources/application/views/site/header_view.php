                ...
                <ul class="nav navbar-nav nav-right">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" role="presentation" href="<?php echo base_url();?>index.php/gtkhoahoc/khoc">Giới Thiệu</a>
                            <a class="dropdown-item" role="presentation" href="<?php echo base_url();?>index.php/khoahoc/kh">Nội Dung</a>
                        </div>
                    </li>
                    <!--Khuyến mãi-->
                    <li class="nav-item" role="presentation">
