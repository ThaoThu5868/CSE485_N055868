...
<div class="me-body" style="background-color:white">
        ...
        <div class="container" >
            ...
            <div class="row projects" >
                ...
                <div class="col-sm-6 item">
                    <div class="row row1">
                        <div class="col-md-12 col-lg-5"><a href="<?php echo base_url();?>index.php/gtkhoahoc/khoc"><img class="img-fluid w3-hover-opacity w3-animate-zoom" src="<?php echo base_url();?>assets/img/khoahoc/<?php echo $row['LINKKH'];?>.jpg"  /></a></div>
                        <div class="col">
                            <h3 class="name"><?php echo $row['TIEUDEKH'];?></h3>
                            <p class="description"><?php echo $row['TOMTATKH'];?></p>
                            <a href="#" class="action" style="float: right;"><i class="fa fa-arrow-circle-right" style="font-size: 30px;"></i></a>
                        </div>
                    </div>
                </div>
                 <?php 
    ...
    <div class="container xemthem" style="margin-top:30px;">
       <a href="<?php echo base_url();?>index.php/gtkhoahoc/khoc"><button class="btn btn-primary" type="button">XEM THÊM</button></a>
    </div>
    <!--Khuyến mại-->
            ...
            <div class="row articles" style="margin-top:40px">
                <?php  foreach ($arr3KM as $row) { ?>
                    <div class="col-sm-6 col-md-4 item">
                        <div class="item1">
                             <a href="<?php echo base_url();?>index.php/km/khuyenmai"><img class="img-fluid w3-hover-opacity w3-animate-zoom" src="<?php echo base_url();?>assets/img/khuyenmai/<?php echo $row['LINKKM'];?>.jpg"  /></a>
        ...
        <div class="row people" style="margin-top:40px">
            ...
            <!-- <div class="col-md-6 col-lg-3 item" >
                ...
                <div class="col-md-6 col-lg-4 item ">
                    <div class="box" style="background-color:#fbdada" ><img class="w3-hover-opacity rounded-circle  w3-animate-zoom  "src="<?php echo base_url();?>assets/img/giangvien/<?php echo $row['LINKGV'];?>.jpg"/>
                        <h3 class="name"><?php echo $row['TENGV'];?></h3>
                        <p class="title"><?php echo $row['TIEUDEGV'];?></p>
                        <p class="description"><?php echo $row['TOMTATGV'];?></p> 
                    </div>
